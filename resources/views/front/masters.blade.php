...
<head>
    ...
    <!--google fonts-->
    <link href="../fonts.googleapis.com/css1644.css?family=Montserrat:400,500,600,700%7COpen+Sans:400,600&amp;display=swap"
          rel="stylesheet">
    ...
    <!--ytplayer css-->
    <link rel="stylesheet" href="{{asset('theme/css/jquery.mb.YTPlayer.min.css')}}">
    <!--Owl carousel css-->
                ...
                <div class="col-md-7 col-lg-7 d-none d-md-block d-lg-block">
                    <div class="topbar-text text-white">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="fas fa-phone-alt mr-1"></span> 0723405320</li>
                        </ul>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg fixed-top white-bg">
        <div class="container">
            <a class="navbar-brand" href="index-2.html">
                <img width="280" src="{{asset('theme/img/website logos-4.png')}}" alt="Vartech East Africa" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu">
                    ...
                    <li><a href="about-us.html">Brands</a></li>

                    <li><a href="services.html">Partners</a></li>
                    <li><a href="project.html">You</a></li>
                    <li><a href="project.html">About Us</a></li>
                    <li><a href="project.html">Case Study</a></li>
                    <li><a href="contact-us.html">Contact Us</a></li>
                    <li><a href="#" class="btn secondary-solid-btn check-btn">Investor Center</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-5">
                    <p class="copyright-text pb-0 mb-0">Copyrights © {{date('Y')}}. All
                        rights reserved by
                        <a href="#" target="_blank">Vartech East Africa</a></p>
                </div>
